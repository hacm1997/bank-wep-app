import { deletLink } from '@/libs/shared/api/link'
...
export const AlertDeleteLinkModal = ({ handleShowModal, link_id, name, refetch }: Props) => {

    const handlerCreateLink = () => {
        const toastId = toast.loading("Deleting bank...");
        if (link_id) {
            deletLink(link_id).then(() => {
                toast.update(toastId, {
                    render: "Bank delete of parnet list successfully!",
                    type: "success",
                    isLoading: false,
                    autoClose: 3000,
                });
                ...
                console.error(error)
                toast.update(toastId, {
                    render: "Failed to delete bank to parnet list",
                    type: "error",
                    isLoading: false,
                    autoClose: 3000,
                });
            ...
            toast.error('link_id not provided')
        }
    }
    return (
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Delete {name} of partner list?</h3>
