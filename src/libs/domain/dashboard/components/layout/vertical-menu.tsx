...
export const VerticalMenu = ({ isMenuOpen }: Props) => {
    ...
    return (
        <div className={`z-10 fixed top-0 left-0 h-screen w-64 bg-[#14171F] border-none transition-transform duration-300 lg:block ${isMenuOpen ? "translate-x-0" : "-translate-x-64"} lg:translate-x-0`}>
